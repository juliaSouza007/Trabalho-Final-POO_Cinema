...
//                        );
    ...
    public static void salvar(List<Cinema> lista) {
    ...
    public static Cinema obtemObjeto(int id) throws CinemaNaoEncontradaException, FalhaConexaoException {
        ...
        try {
            ...
            if (resultado.next()) {
                // Obtenho os dados
//                return new Cinema(resultado.getInt(ID_POSICAO_TABELA),
//                        resultado.getString(NOME_POSICAO_TABELA),
//                        resultado.getString(LOCAL_POSICAO_TABELA)
//                );
            }
